@section('kakirigi/ostreidae::primary_menu')
...
<ul class="nav navbar-nav pull-right">
	<li>
		<a href="<?php echo handles('kakirigi/ostreidae::/'); ?>" target="_blank">View Website</a>
	</li>
</ul>
@stop
...
$navbar = new Fluent(array(
	...
	'menu'  => View::yieldContent('kakirigi/ostreidae::primary_menu'),
)); ?>
